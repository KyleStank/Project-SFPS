...
{
    /// <summary>
    /// Abstract class that provides common functionality to custom inspector editors.
    /// </summary>
    public abstract class SFPSBaseInspector<T> : UnityEditor.Editor where T : Object
    {
        /// <summary>
